		...
		void InitializeComponent(void)
		{
			...
			this->ôàéëToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->ñîçäàòüToolStripMenuItem,
					this->îòêğûòüToolStripMenuItem, this->âûõîäToolStripMenuItem
			});
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Leelawadee", 20, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(56, 56);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(365, 32);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Ïğèëîæåíèå \"Áàçà äàííûõ\"";
			// 
			// MainForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(482, 142);
